...
function Login() {
  ...
  return (
    <div>
      <div className="container-fluid pt-5" style={{background: `url(${bgLogin})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '850px', margin: 'auto'}}>
        ...
        <div className="d-flex row justify-content-center">
          <div className="black-box col col-sm-8 col-md-6 col-lg-3 mt-5 bg-dark pb-5 m-2">
            <div className="text-center pt-2 text-white">
              <img src={logofooter} style={{maxWidth: "200px", position:"center"}} className="img my-4" alt="logo-Bye-Buy"/>
            </div>
