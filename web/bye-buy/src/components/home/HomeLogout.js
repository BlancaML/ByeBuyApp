                    ...
                    <div className="card bg-dark black-box">
                         ...
                         <div className="p-2 bd-highlight">
                              ...
                              <div className="d-flex flex-row mt-5">
                                   <div className="p-2">
                                   <Link to='/' className="mt-3 p-3 list-item-link rounded-pill"><b>List an item</b></Link>
                                   </div>
                                   <div className="p-2">
                                   <Link to='/items' className="mt-3 p-3 browse-item-link rounded-pill"><b>Browse items</b></Link>
                                   </div>
                              </div>
                         </div>
                              <img src={buyee} style={{maxWidth: "220px"}} className="img-buyee" alt="logo-Buyee"/>
